...
####################################################################################
####################################################################################
## explore relationship between PCs and selected trial vars for Figure 4
####################################################################################
####################################################################################
...
corbin_biplot_for_ppca(PCA=pca_model, dataframe_of_phenotypes=checklist_change_data, pheno_list=checklist_change_var, class_info = class_info,
                       npcs = 2, annot_data = annot_data, ordered_id = ordered_id, filename="Figure4_checklist_change")
...
####################################################################################
####################################################################################
## plot eigenvalues for Figure S3
####################################################################################
####################################################################################

filename <- paste0(results_dir,"Figures\\ForPaper\\FigureS3_scree.pdf")
pdf(filename)
